...
public class SOSA {
  ...
  public static String nameSpace = "http://www.w3.org/ns/sosa/";

  public static Resource Observation = ResourceFactory.createResource(nameSpace + "Observation");

  public static Property isObservedBy         = ResourceFactory.createProperty(nameSpace + "isObservedBy");
  public static Property hasFeatureOfInterest = ResourceFactory.createProperty(nameSpace + "hasFeatureOfInterest");
  public static Property madeBySensor         = ResourceFactory.createProperty(nameSpace + "madebySensor");
  public static Property madeObservation      = ResourceFactory.createProperty(nameSpace + "madeObservation");
  public static Property resultTime           = ResourceFactory.createProperty(nameSpace + "resultTime");
  public static Property hasSimpleResult      = ResourceFactory.createProperty(nameSpace + "hasSimpleResult");

  public static Resource FeatureOfInterest    = ResourceFactory.createResource(nameSpace + "FeatureOfInterest");
  public static Resource Sensor             = ResourceFactory.createResource(nameSpace + "Sensor");
  public static Property observes           = ResourceFactory.createProperty(nameSpace + "observes");
  public static Resource ObservableProperty = ResourceFactory.createResource(nameSpace + "ObservableProperty");
